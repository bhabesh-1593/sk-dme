...
@AnalyzeClasses(packagesOf = ClaimssubmissionApp.class, importOptions = DoNotIncludeTests.class)
...
//        .whereLayer("Domain").mayOnlyBeAccessedByLayers("Persistence", "Service", "Security", "Web", "Config")
        ...
        .ignoreDependency(belongToAnyOf(ClaimssubmissionApp.class), alwaysTrue());
}
