...
import com.sunknowledge.dme.rcm.UtilityapisApp;
...
@SpringBootTest(classes = { UtilityapisApp.class, AsyncSyncConfiguration.class, TestSecurityConfiguration.class })
@EmbeddedSQL
