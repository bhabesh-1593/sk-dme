...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.sunknowledge.dme.rcm.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.sunknowledge.dme.rcm.security.DomainUserDetailsService", "createSpringSecurityUser");
    }
}
