...
class SalesOrderItemDetailsResourceIT {
    ...
    private static final Long DEFAULT_SALES_ORDER_DETAIL_ITEM_ID = 1L;
    private static final Long UPDATED_SALES_ORDER_DETAIL_ITEM_ID = 2L;
    ...
    void getAllSalesOrderItemDetails() {
        ...
        webTestClient
            ...
            .value(hasItem(DEFAULT_SALES_ORDER_DETAIL_ITEM_ID.intValue()))
    ...
    void getSalesOrderItemDetails() {
        ...
        webTestClient
            ...
            .jsonPath("$.salesOrderDetailItemId")
            .value(is(DEFAULT_SALES_ORDER_DETAIL_ITEM_ID.intValue()))
            .jsonPath("$.salesOrderDetailItemName")
    ...
    @Test
    void putExistingSalesOrderItemDetails() throws Exception {
        // Initialize the database
        salesOrderItemDetailsRepository.save(salesOrderItemDetails).block();
