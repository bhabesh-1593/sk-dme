...
class SalesOrderClinicalDetailsResourceIT {
    ...
    private static final Integer DEFAULT_SALES_ODER_CLINICAL_DETAILS_ID = 1;
    private static final Integer UPDATED_SALES_ODER_CLINICAL_DETAILS_ID = 2;
...
//            .salesOderClinicalDetailsId(DEFAULT_SALES_ODER_CLINICAL_DETAILS_ID)
...
//        SalesOrderClinicalDetails salesOrderClinicalDetails = new SalesOrderClinicalDetails()
//            .salesOderClinicalDetailsId(UPDATED_SALES_ODER_CLINICAL_DETAILS_ID)
...
//            .bodyValue(TestUtil.convertObjectToJsonBytes(salesOrderClinicalDetails))
//            .exchange()
//            .expectStatus()
//            .isCreated();
//
...
//        );
//        assertThat(testSalesOrderClinicalDetails.getSalesOderClinicalDetailsId()).isEqualTo(DEFAULT_SALES_ODER_CLINICAL_DETAILS_ID);
//        assertThat(testSalesOrderClinicalDetails.getSalesOderId()).isEqualTo(DEFAULT_SALES_ODER_ID);
...
//        salesOrderClinicalDetails.setId(1L);
//
//        int databaseSizeBeforeCreate = salesOrderClinicalDetailsRepository.findAll().collectList().block().size();
//
...
//
//    @Test
//    void checkSalesOderClinicalDetailsIdIsRequired() throws Exception {
//        int databaseSizeBeforeTest = salesOrderClinicalDetailsRepository.findAll().collectList().block().size();
//        // set the field null
//        salesOrderClinicalDetails.setSalesOderClinicalDetailsId(null);
//
...
//        int databaseSizeBeforeTest = salesOrderClinicalDetailsRepository.findAll().collectList().block().size();
//        // set the field null
//        salesOrderClinicalDetails.setSalesOderId(null);
//
//        // Create the SalesOrderClinicalDetails, which fails.
//
//        webTestClient
...
//
//    @Test
//    void getAllSalesOrderClinicalDetailsAsStream() {
//        // Initialize the database
//        salesOrderClinicalDetailsRepository.save(salesOrderClinicalDetails).block();
//
//        List<SalesOrderClinicalDetails> salesOrderClinicalDetailsList = webTestClient
//            .get()
//            .uri(ENTITY_API_URL)
...
//            .returnResult(SalesOrderClinicalDetails.class)
//            .getResponseBody()
//            .filter(salesOrderClinicalDetails::equals)
//            .collectList()
//            .block(Duration.ofSeconds(5));
//
//        assertThat(salesOrderClinicalDetailsList).isNotNull();
//        assertThat(salesOrderClinicalDetailsList).hasSize(1);
//        SalesOrderClinicalDetails testSalesOrderClinicalDetails = salesOrderClinicalDetailsList.get(0);
//        assertThat(testSalesOrderClinicalDetails.getSalesOderClinicalDetailsId()).isEqualTo(DEFAULT_SALES_ODER_CLINICAL_DETAILS_ID);
//        assertThat(testSalesOrderClinicalDetails.getSalesOderId()).isEqualTo(DEFAULT_SALES_ODER_ID);
//        assertThat(testSalesOrderClinicalDetails.getPatientId()).isEqualTo(DEFAULT_PATIENT_ID);
//        assertThat(testSalesOrderClinicalDetails.getPatientWeightInKg()).isEqualTo(DEFAULT_PATIENT_WEIGHT_IN_KG);
...
//            .expectBody()
//            .jsonPath("$.[*].id")
//            .value(hasItem(salesOrderClinicalDetails.getId().intValue()))
//            .jsonPath("$.[*].salesOderClinicalDetailsId")
//            .value(hasItem(DEFAULT_SALES_ODER_CLINICAL_DETAILS_ID))
...
//        webTestClient
//            .get()
//            .uri(ENTITY_API_URL_ID, salesOrderClinicalDetails.getId())
//            .accept(MediaType.APPLICATION_JSON)
//            .exchange()
//            .expectStatus()
//            .isOk()
...
//            .expectBody()
//            .jsonPath("$.id")
//            .value(is(salesOrderClinicalDetails.getId().intValue()))
//            .jsonPath("$.salesOderClinicalDetailsId")
//            .value(is(DEFAULT_SALES_ODER_CLINICAL_DETAILS_ID))
//            .jsonPath("$.salesOderId")
...
//
//    @Test
//    void putNewSalesOrderClinicalDetails() throws Exception {
//        // Initialize the database
//        salesOrderClinicalDetailsRepository.save(salesOrderClinicalDetails).block();
//
...
//        webTestClient
//            .put()
//            .uri(ENTITY_API_URL_ID, updatedSalesOrderClinicalDetails.getId())
//            .contentType(MediaType.APPLICATION_JSON)
//            .bodyValue(TestUtil.convertObjectToJsonBytes(updatedSalesOrderClinicalDetails))
//            .exchange()
//            .expectStatus()
//            .isOk();
//
...
//            salesOrderClinicalDetailsList.size() - 1
//        );
//        assertThat(testSalesOrderClinicalDetails.getSalesOderClinicalDetailsId()).isEqualTo(UPDATED_SALES_ODER_CLINICAL_DETAILS_ID);
//        assertThat(testSalesOrderClinicalDetails.getSalesOderId()).isEqualTo(UPDATED_SALES_ODER_ID);
...
//        int databaseSizeBeforeUpdate = salesOrderClinicalDetailsRepository.findAll().collectList().block().size();
//        salesOrderClinicalDetails.setId(count.incrementAndGet());
//
...
//        partialUpdatedSalesOrderClinicalDetails.setId(salesOrderClinicalDetails.getId());
//
...
//        webTestClient
//            .patch()
//            .uri(ENTITY_API_URL_ID, partialUpdatedSalesOrderClinicalDetails.getId())
