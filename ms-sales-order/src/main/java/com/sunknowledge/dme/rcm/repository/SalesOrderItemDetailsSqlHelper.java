...
public class SalesOrderItemDetailsSqlHelper {
    ...
    public static List<Expression> getColumns(Table table, String columnPrefix) {
        ...
        columns.add(Column.aliased("sales_order_details_stocking_uom_name", table, columnPrefix + "_sales_order_details_stocking_uom_name"));
        ...
        columns.add(Column.aliased("sales_order_details_next_billing_date", table, columnPrefix + "_sales_order_details_next_billing_date"));
        ...
        columns.add(Column.aliased("sales_order_details_price_option_name", table, columnPrefix + "_sales_order_details_price_option_name"));
        columns.add(
            Column.aliased("sales_order_details_extended_charge_amount", table, columnPrefix + "_sales_order_details_extended_charge_amount")
        );
        columns.add(
            Column.aliased(
        ...
        columns.add(
            Column.aliased(
                "sales_order_details_secondary_billingadditional_modifier_2",
                table,
                columnPrefix + "_sales_order_details_secondary_billingadditional_modifier_2"
            )
        );
        columns.add(
            Column.aliased(
                "sales_order_details_secondary_billingadditional_modifier_3",
                table,
                columnPrefix + "_sales_order_details_secondary_billingadditional_modifier_3"
            )
        );
        columns.add(
            Column.aliased(
                "sales_order_details_secondary_billingadditional_modifier_4",
                table,
                columnPrefix + "_sales_order_details_secondary_billingadditional_modifier_4"
            )
        );
        columns.add(
            Column.aliased(
        ...
        columns.add(Column.aliased("sales_order_details_cmnpar_cmn_form_id", table, columnPrefix + "_sales_order_details_cmnpar_cmn_form_id"));
        columns.add(Column.aliased("sales_order_details_cmnpar_cmn_key", table, columnPrefix + "_sales_order_details_cmnpar_cmn_key"));
        columns.add(Column.aliased("sales_order_details_cmnpar_cmn_create_date", table, columnPrefix + "_sales_order_details_cmnpar_cmn_create_date"));
        columns.add(Column.aliased("sales_order_details_cmnpar_cmn_expiration_date", table, columnPrefix + "_sales_order_details_cmnpar_cmn_expiration_date"));
        columns.add(Column.aliased("sales_order_details_cmnpar_cmn_initial_date", table, columnPrefix + "_sales_order_details_cmnpar_cmn_initial_date"));
        columns.add(Column.aliased("sales_order_details_cmnpar_cmn_renewal_date", table, columnPrefix + "_sales_order_details_cmnpar_cmn_renewal_date"));
        columns.add(Column.aliased("sales_order_details_cmnpar_cmn_recertification_date", table, columnPrefix + "_sales_order_details_cmnpar_cmn_recertification_date"));
        columns.add(Column.aliased("sales_order_details_cmnpar_cmn_physician_date", table, columnPrefix + "_sales_order_details_cmnpar_cmn_physician_date"));
        columns.add(Column.aliased("sales_order_details_cmnpar_cmn_status", table, columnPrefix + "_sales_order_details_cmnpar_cmn_status"));
        ...
        columns.add(Column.aliased("sales_order_details_cmnpar_par_initial_date", table, columnPrefix + "_sales_order_details_cmnpar_par_initial_date"));
        columns.add(Column.aliased("sales_order_details_cmnpar_par_expiration_date", table, columnPrefix + "_sales_order_details_cmnpar_par_expiration_date"));
        columns.add(Column.aliased("sales_order_details_cmnpar_cmn_log_date", table, columnPrefix + "_sales_order_details_cmnpar_cmn_log_date"));
        columns.add(Column.aliased("sales_order_details_cmnpar_cmn_length_of_need", table, columnPrefix + "_sales_order_details_cmnpar_cmn_length_of_need"));
        columns.add(Column.aliased("sales_order_details_cmnpar_cmn_printed_date", table, columnPrefix + "_sales_order_details_cmnpar_cmn_printed_date"));
        columns.add(Column.aliased("sales_order_details_cmnpar_cmn_printed_by", table, columnPrefix + "_sales_order_details_cmnpar_cmn_printed_by"));
        columns.add(Column.aliased("sales_order_details_cmnpar_faxed_date", table, columnPrefix + "_sales_order_details_cmnpar_faxed_date"));
        columns.add(Column.aliased("sales_order_details_cmnpar_cmn_placeholder", table, columnPrefix + "_sales_order_details_cmnpar_cmn_placeholder"));
        columns.add(Column.aliased("sales_order_details_cmnpar_cmn_faxed_by", table, columnPrefix + "_sales_order_details_cmnpar_cmn_faxed_by"));
        columns.add(Column.aliased("sales_order_details_cmnpar_cmn_logged_by", table, columnPrefix + "_sales_order_details_cmnpar_cmn_logged_by"));
        columns.add(Column.aliased("sales_order_details_cmnpar_number_of_refills", table, columnPrefix + "_sales_order_details_cmnpar_number_of_refills"));
        ...
        columns.add(Column.aliased("icd_field_pointer", table, columnPrefix + "_icd_field_pointer"));
        ...
        columns.add(Column.aliased("item_details_sales_order_id", table, columnPrefix + "_item_details_sales_order_id"));
        return columns;
    }
}
