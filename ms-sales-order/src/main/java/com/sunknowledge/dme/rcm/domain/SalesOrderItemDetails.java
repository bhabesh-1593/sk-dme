...
//    private Long id;
    ...
    @Column("sales_order_details_stocking_uom_name")
    ...
    @Column("sales_order_details_modifier1")
    private String salesOrderDetailModifier1;

    @Column("sales_order_details_modifier2")
    private String salesOrderDetailModifier2;

    @Column("sales_order_details_modifier3")
    private String salesOrderDetailModifier3;

    @Column("sales_order_details_modifier4")
    ...
    @Column("sales_order_details_abn_modifier1")
    private String salesOrderDetailAbnModifier1;

    @Column("sales_order_details_abn_modifier2")
    ...
    @Column("sales_order_details_item_user1")
    private String salesOrderDetailItemUser1;

    @Column("sales_order_details_item_user2")
    private String salesOrderDetailItemUser2;

    @Column("sales_order_details_item_user3")
    private String salesOrderDetailItemUser3;

    @Column("sales_order_details_item_user4")
    ...
    @Column("sales_order_details_mctp_modifier1")
    private String salesOrderDetailMctpModifier1;

    @Column("sales_order_details_mctp_modifier2")
    private String salesOrderDetailMctpModifier2;

    @Column("sales_order_details_mctp_modifier3")
    private String salesOrderDetailMctpModifier3;

    @Column("sales_order_details_mctp_modifier4")
    ...
    @Column("sales_order_details_addtl_modifier1")
    private String salesOrderDetailAddtlModifier1;

    @Column("sales_order_details_addtl_modifier2")
    private String salesOrderDetailAddtlModifier2;

    @Column("sales_order_details_addtl_modifier3")
    private String salesOrderDetailAddtlModifier3;

    @Column("sales_order_details_addtl_modifier4")
    ...
    @Column("sales_order_details_secondary_billing_modifier1")
    private String salesOrderDetailSecondaryBillingModifier1;

    @Column("sales_order_details_secondary_billing_modifier2")
    private String salesOrderDetailSecondaryBillingModifier2;

    @Column("sales_order_details_secondary_billing_modifier3")
    private String salesOrderDetailSecondaryBillingModifier3;

    @Column("sales_order_details_secondary_billing_modifier4")
    private String salesOrderDetailSecondaryBillingModifier4;

    @Column("sales_order_details_secondary_billing_additional_modifier1")
    private String salesOrderDetailSecondaryBillingAdditionalModifier1;

    @Column("sales_order_details_secondary_billingadditional_modifier2")
    private String salesOrderDetailSecondaryBillingadditionalModifier2;

    @Column("sales_order_details_secondary_billingadditional_modifier3")
    private String salesOrderDetailSecondaryBillingadditionalModifier3;

    @Column("sales_order_details_secondary_billingadditional_modifier4")
    ...
    @Column("icd_field_pointer")
    private String icdFieldPointer;
    ...
    @Column("sales_order_details_cmnpar_length_of_need")
    private String salesOrderDetailsCmnparLengthOfNeed;
	...
	public String getIcdFieldPointer() {
		return icdFieldPointer;
	}

	public SalesOrderItemDetails icdFieldPointer(String icdFieldPointer) {
        this.setIcdFieldPointer(icdFieldPointer);
        return this;
    }

	public void setIcdFieldPointer(String icdFieldPointer) {
		this.icdFieldPointer = icdFieldPointer;
	}
    ...
    public SalesOrderItemDetails itemUom(String itemUom) {
	...
	public String getSalesOrderDetailsCmnparLengthOfNeed() {
		return salesOrderDetailsCmnparLengthOfNeed;
	}

    public SalesOrderItemDetails salesOrderDetailsCmnparLengthOfNeed(String salesOrderDetailsCmnparLengthOfNeed) {
        this.setSalesOrderDetailsCmnparLengthOfNeed(salesOrderDetailsCmnparLengthOfNeed);
        return this;
    }

	public void setSalesOrderDetailsCmnparLengthOfNeed(String salesOrderDetailsCmnparLengthOfNeed) {
		this.salesOrderDetailsCmnparLengthOfNeed = salesOrderDetailsCmnparLengthOfNeed;
	}
	...
	public String toString() {
		return "SalesOrderItemDetails [salesOrderItemDetailsId=" + salesOrderItemDetailsId + ", salesOrderId="
				+ salesOrderId + ", patientId=" + patientId + ", itemLocationId=" + itemLocationId
				+ ", salesOrderDetailItemId=" + salesOrderDetailItemId + ", salesOrderDetailItemName="
				+ salesOrderDetailItemName + ", salesOrderDetailStockingUom=" + salesOrderDetailStockingUom
				+ ", salesOrderDetailStockingUomName=" + salesOrderDetailStockingUomName
				+ ", salesOrderDetailItemDescription=" + salesOrderDetailItemDescription
				+ ", salesOrderDetailDefaultVendor=" + salesOrderDetailDefaultVendor + ", salesOrderDetailOriginalDos="
				+ salesOrderDetailOriginalDos + ", salesOrderDetailPreviousBillingDate="
				+ salesOrderDetailPreviousBillingDate + ", salesOrderDetailNextBillingDate="
				+ salesOrderDetailNextBillingDate + ", salesOrderDetailDosTo=" + salesOrderDetailDosTo
				+ ", salesOrderDetailNextPeriod=" + salesOrderDetailNextPeriod + ", salesOrderDetailSpecialPricing="
				+ salesOrderDetailSpecialPricing + ", salesOrderDetailPriceOverride=" + salesOrderDetailPriceOverride
				+ ", salesOrderDetailSpecialTaxRate=" + salesOrderDetailSpecialTaxRate + ", salesOrderDetailQty="
				+ salesOrderDetailQty + ", salesOrderDetailBqty=" + salesOrderDetailBqty + ", salesOrderDetailLineQty="
				+ salesOrderDetailLineQty + ", salesOrderDetailProcCode=" + salesOrderDetailProcCode
				+ ", salesOrderDetailPriceOption=" + salesOrderDetailPriceOption + ", salesOrderDetailModifier1="
				+ salesOrderDetailModifier1 + ", salesOrderDetailModifier2=" + salesOrderDetailModifier2
				+ ", salesOrderDetailModifier3=" + salesOrderDetailModifier3 + ", salesOrderDetailModifier4="
				+ salesOrderDetailModifier4 + ", salesOrderDetailChargeAmt=" + salesOrderDetailChargeAmt
				+ ", salesOrderDetailAllowedAmt=" + salesOrderDetailAllowedAmt + ", salesOrderDetailTaxable="
				+ salesOrderDetailTaxable + ", salesOrderDetailAbn=" + salesOrderDetailAbn
				+ ", salesOrderDetailAbnUpgrade=" + salesOrderDetailAbnUpgrade + ", salesOrderDetailAbnPrintDate="
				+ salesOrderDetailAbnPrintDate + ", salesOrderDetailAbnItem=" + salesOrderDetailAbnItem
				+ ", salesOrderDetailAbnProcCode=" + salesOrderDetailAbnProcCode + ", salesOrderDetailAbnAllow="
				+ salesOrderDetailAbnAllow + ", salesOrderDetailAbnCharge=" + salesOrderDetailAbnCharge
				+ ", salesOrderDetailAbnModifier1=" + salesOrderDetailAbnModifier1 + ", salesOrderDetailAbnModifier2="
				+ salesOrderDetailAbnModifier2 + ", salesOrderDetailTaxRate=" + salesOrderDetailTaxRate
				+ ", salesOrderDetailTaxZone=" + salesOrderDetailTaxZone + ", salesOrderDetailNonTaxReason="
				+ salesOrderDetailNonTaxReason + ", salesOrderDetailNote=" + salesOrderDetailNote
				+ ", salesOrderDetailSaleType=" + salesOrderDetailSaleType + ", salesOrderDetailItemGroup="
				+ salesOrderDetailItemGroup + ", salesOrderDetailItemUser1=" + salesOrderDetailItemUser1
				+ ", salesOrderDetailItemUser2=" + salesOrderDetailItemUser2 + ", salesOrderDetailItemUser3="
				+ salesOrderDetailItemUser3 + ", salesOrderDetailItemUser4=" + salesOrderDetailItemUser4
				+ ", salesOrderDetailConvertedToPurchase=" + salesOrderDetailConvertedToPurchase
				+ ", salesOrderDetailManualConvertToPurchaseMctp=" + salesOrderDetailManualConvertToPurchaseMctp
				+ ", salesOrderDetailMctpChargeAmt=" + salesOrderDetailMctpChargeAmt
				+ ", salesOrderDetailMctpAllowedAmt=" + salesOrderDetailMctpAllowedAmt
				+ ", salesOrderDetailMctpModifier1=" + salesOrderDetailMctpModifier1
				+ ", salesOrderDetailMctpModifier2=" + salesOrderDetailMctpModifier2
				+ ", salesOrderDetailMctpModifier3=" + salesOrderDetailMctpModifier3
				+ ", salesOrderDetailMctpModifier4=" + salesOrderDetailMctpModifier4 + ", salesOrderDetailMctpPeriod="
				+ salesOrderDetailMctpPeriod + ", salesOrderDetailAddtlModifier1=" + salesOrderDetailAddtlModifier1
				+ ", salesOrderDetailAddtlModifier2=" + salesOrderDetailAddtlModifier2
				+ ", salesOrderDetailAddtlModifier3=" + salesOrderDetailAddtlModifier3
				+ ", salesOrderDetailAddtlModifier4=" + salesOrderDetailAddtlModifier4
				+ ", salesOrderDetailNextDateOfService=" + salesOrderDetailNextDateOfService
				+ ", salesOrderDetailPriceTable=" + salesOrderDetailPriceTable + ", salesOrderDetailPriceOptionName="
				+ salesOrderDetailPriceOptionName + ", salesOrderDetailExtendedChargeAmount="
				+ salesOrderDetailExtendedChargeAmount + ", salesOrderDetailExtendedAllowanceAmount="
				+ salesOrderDetailExtendedAllowanceAmount + ", salesOrderDetailItemNdcCode="
				+ salesOrderDetailItemNdcCode + ", salesOrderDetailManufacturer=" + salesOrderDetailManufacturer
				+ ", salesOrderDetailCbPricing=" + salesOrderDetailCbPricing + ", salesOrderDetailCbPriceTableOverride="
				+ salesOrderDetailCbPriceTableOverride + ", salesOrderDetailCbOverride=" + salesOrderDetailCbOverride
				+ ", salesOrderDetailMessages=" + salesOrderDetailMessages + ", salesOrderDetailLocation="
				+ salesOrderDetailLocation + ", salesOrderDetailCaloriesPerDay=" + salesOrderDetailCaloriesPerDay
				+ ", salesOrderDetailSecondaryBillingProcudureCode=" + salesOrderDetailSecondaryBillingProcudureCode
				+ ", salesOrderDetailSecondaryBillingPriceOption=" + salesOrderDetailSecondaryBillingPriceOption
				+ ", salesOrderDetailSecondaryBillingPriceOptionName=" + salesOrderDetailSecondaryBillingPriceOptionName
				+ ", salesOrderDetailSecondaryBillingModifier1=" + salesOrderDetailSecondaryBillingModifier1
				+ ", salesOrderDetailSecondaryBillingModifier2=" + salesOrderDetailSecondaryBillingModifier2
				+ ", salesOrderDetailSecondaryBillingModifier3=" + salesOrderDetailSecondaryBillingModifier3
				+ ", salesOrderDetailSecondaryBillingModifier4=" + salesOrderDetailSecondaryBillingModifier4
				+ ", salesOrderDetailSecondaryBillingAdditionalModifier1="
				+ salesOrderDetailSecondaryBillingAdditionalModifier1
				+ ", salesOrderDetailSecondaryBillingadditionalModifier2="
				+ salesOrderDetailSecondaryBillingadditionalModifier2
				+ ", salesOrderDetailSecondaryBillingadditionalModifier3="
				+ salesOrderDetailSecondaryBillingadditionalModifier3
				+ ", salesOrderDetailSecondaryBillingadditionalModifier4="
				+ salesOrderDetailSecondaryBillingadditionalModifier4 + ", salesOrderDetailSecondaryBillingIgnore="
				+ salesOrderDetailSecondaryBillingIgnore + ", salesOrderDetailSecondarySpecialBilling="
				+ salesOrderDetailSecondarySpecialBilling + ", salesOrderDetailSpanDateSplitBilling="
				+ salesOrderDetailSpanDateSplitBilling + ", salesOrderDetailManufacturerItemIdNumber="
				+ salesOrderDetailManufacturerItemIdNumber + ", cmnId=" + cmnId + ", cmnparCmnFormId=" + cmnparCmnFormId
				+ ", cmnparCmnKey=" + cmnparCmnKey + ", cmnparCmnCreateDate=" + cmnparCmnCreateDate
				+ ", cmnparCmnExpirationDate=" + cmnparCmnExpirationDate + ", cmnparCmnInitialDate="
				+ cmnparCmnInitialDate + ", cmnparCmnRenewalDate=" + cmnparCmnRenewalDate
				+ ", cmnparCmnRecertificationDate=" + cmnparCmnRecertificationDate + ", cmnparCmnPhysicianDate="
				+ cmnparCmnPhysicianDate + ", cmnparCmnStatus=" + cmnparCmnStatus + ", cmnparParId=" + cmnparParId
				+ ", cmnparParDescr=" + cmnparParDescr + ", cmnparParInitialDate=" + cmnparParInitialDate
				+ ", cmnparParExpirationDate=" + cmnparParExpirationDate + ", cmnparCmnLogDate=" + cmnparCmnLogDate
				+ ", cmnparCmnLengthOfNeed=" + cmnparCmnLengthOfNeed + ", cmnparCmnPrintedDate=" + cmnparCmnPrintedDate
				+ ", cmnparCmnPrintedBy=" + cmnparCmnPrintedBy + ", cmnparFaxedDate=" + cmnparFaxedDate
				+ ", cmnparCmnPlaceholder=" + cmnparCmnPlaceholder + ", cmnparCmnFaxedBy=" + cmnparCmnFaxedBy
				+ ", cmnparCmnLoggedBy=" + cmnparCmnLoggedBy + ", cmnparNumberOfRefills=" + cmnparNumberOfRefills
				+ ", status=" + status + ", createdById=" + createdById + ", createdByName=" + createdByName
				+ ", createdDate=" + createdDate + ", updatedById=" + updatedById + ", updatedByName=" + updatedByName
				+ ", updatedDate=" + updatedDate + ", salesOrderItemDetailsUuid=" + salesOrderItemDetailsUuid
				+ ", icdFieldPointer=" + icdFieldPointer + ", salesOrderItemNumber=" + salesOrderItemNumber
				+ ", itemUom=" + itemUom + ", salesOrderDetailsCmnparLengthOfNeed="
				+ salesOrderDetailsCmnparLengthOfNeed + "]";
	}
