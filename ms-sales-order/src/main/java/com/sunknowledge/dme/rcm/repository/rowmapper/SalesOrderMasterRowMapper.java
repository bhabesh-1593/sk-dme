...
//        entity.setId(converter.fromRow(row, prefix + "_id", Long.class));
        entity.setSalesOderId(converter.fromRow(row, prefix + "_sales_oder_id", Integer.class));
        entity.setSalesOderNo(converter.fromRow(row, prefix + "_sales_oder_no", String.class));
        ...
        entity.setPodStatusDateTime(converter.fromRow(row, prefix + "_pod_status_datetime", ZonedDateTime.class));
        entity.setPodLastMessage(converter.fromRow(row, prefix + "_pod_last_message", String.class));
        entity.setPodMessageDateTime(converter.fromRow(row, prefix + "_pod_message_datetime", ZonedDateTime.class));
