...
public interface SalesOrderItemDetailsRepository
    ...
    @Query("SELECT * FROM t_sales_order_item_details entity WHERE entity.item_details_sales_order_id = :id")
    Flux<SalesOrderItemDetails> findByItemDetails(Long id);

    @Query("SELECT * FROM t_sales_order_item_details entity WHERE entity.item_details_sales_order_id IS NULL")
    Flux<SalesOrderItemDetails> findAllWhereItemDetailsIsNull();
