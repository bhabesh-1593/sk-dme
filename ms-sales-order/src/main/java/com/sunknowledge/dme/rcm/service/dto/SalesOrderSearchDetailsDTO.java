...
public class SalesOrderSearchDetailsDTO {
    private Long sid;
    private String sno;
    ...
    public SalesOrderSearchDetailsDTO()  //-- Default constructor
    {

    }

    public SalesOrderSearchDetailsDTO(Long sid, String sno, String pFirstName, String pMiddleName, String pLastName, LocalDate pDob, String pInsurerName, String pAddresLine1, String pAddressLine2, String status, String oStatus, LocalDateTime cDate, Long cById, String cByName, Long primaryInsurerId) {
        this.sid = sid;
        this.sno = sno;
