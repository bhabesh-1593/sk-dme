...
//    private Long id;
    ...
    @Column("primary_insurer_payer_id")
    private String primaryInsurerPayerId;

    @Column("secondary_insurer_payer_id")
    private String secondaryInsurerPayerId;

    @Column("tertiary_insurer_payer_id")
    private String tertiaryInsurerPayerId;
    ...
    public SalesOrderInsuranceDetails primaryInsurerPayerId(String primaryInsurerPayerId) {
        this.setPrimaryInsurerPayerId(primaryInsurerPayerId);
        return this;
    }

	public void setPrimaryInsurerPayerId(String primaryInsurerPayerId) {
    ...
    public SalesOrderInsuranceDetails secondaryInsurerPayerId(String secondaryInsurerPayerId) {
        this.setSecondaryInsurerPayerId(secondaryInsurerPayerId);
        return this;
    }

	public void setSecondaryInsurerPayerId(String secondaryInsurerPayerId) {
		this.secondaryInsurerPayerId = secondaryInsurerPayerId;
	}

	public String getTertiaryInsurerPayerId() {
		return tertiaryInsurerPayerId;
	}

    public SalesOrderInsuranceDetails tertiaryInsurerPayerId(String tertiaryInsurerPayerId) {
        this.setTertiaryInsurerPayerId(tertiaryInsurerPayerId);
        return this;
    }

	public void setTertiaryInsurerPayerId(String tertiaryInsurerPayerId) {
		this.tertiaryInsurerPayerId = tertiaryInsurerPayerId;
	}
	...
	public String toString() {
		return "SalesOrderInsuranceDetails [salesOrderInsuranceDetailsId=" + salesOrderInsuranceDetailsId
				+ ", salesOrderId=" + salesOrderId + ", patientId=" + patientId + ", primaryInsurerId="
				+ primaryInsurerId + ", primaryInsurerName=" + primaryInsurerName + ", primaryInsuranceGroupId="
				+ primaryInsuranceGroupId + ", primaryInsuranceGroupName=" + primaryInsuranceGroupName
				+ ", primaryInsurancePlanId=" + primaryInsurancePlanId + ", primaryInsurancePlanType="
				+ primaryInsurancePlanType + ", primaryInsuranceStateId=" + primaryInsuranceStateId
				+ ", primaryInsuranceStateName=" + primaryInsuranceStateName + ", primaryInsurerPolicyNo="
				+ primaryInsurerPolicyNo + ", primaryInsurerPatientIdNumber=" + primaryInsurerPatientIdNumber
				+ ", primaryInsurerEffectiveDate=" + primaryInsurerEffectiveDate + ", primaryInsurerVerificationStatus="
				+ primaryInsurerVerificationStatus + ", primaryInsurerVerificationDate="
				+ primaryInsurerVerificationDate + ", primaryInsurerPayPercentage=" + primaryInsurerPayPercentage
				+ ", primaryBox10d=" + primaryBox10d + ", primaryBox19=" + primaryBox19 + ", primaryBox24ia="
				+ primaryBox24ia + ", primaryBox24ja=" + primaryBox24ja + ", primaryBox24jb=" + primaryBox24jb
				+ ", primaryIncludeBox24Jbstatus=" + primaryIncludeBox24Jbstatus
				+ ", primaryIncludePayerSalesOrderStatus=" + primaryIncludePayerSalesOrderStatus
				+ ", primaryWaitForPreviousPayerBeforeBillingStatus=" + primaryWaitForPreviousPayerBeforeBillingStatus
				+ ", primaryPayPercentageStatus=" + primaryPayPercentageStatus + ", secondaryInsurerId="
				+ secondaryInsurerId + ", secondaryInsurerName=" + secondaryInsurerName + ", secondaryInsuranceGroupId="
				+ secondaryInsuranceGroupId + ", secondaryInsuranceGroupName=" + secondaryInsuranceGroupName
				+ ", secondaryInsurancePlanId=" + secondaryInsurancePlanId + ", secondaryInsurancePlanType="
				+ secondaryInsurancePlanType + ", secondaryInsuranceStateId=" + secondaryInsuranceStateId
				+ ", secondaryInsuranceStateName=" + secondaryInsuranceStateName + ", secondaryInsurerPolicyNo="
				+ secondaryInsurerPolicyNo + ", secondaryInsurerPatientIdNumber=" + secondaryInsurerPatientIdNumber
				+ ", secondaryInsurerEffectiveDate=" + secondaryInsurerEffectiveDate
				+ ", secondaryInsurerVerificationStatus=" + secondaryInsurerVerificationStatus
				+ ", secondaryInsurerVerificationDate=" + secondaryInsurerVerificationDate
				+ ", secondaryInsurerPayPercentage=" + secondaryInsurerPayPercentage + ", secondaryBox10d="
				+ secondaryBox10d + ", secondaryBox19=" + secondaryBox19 + ", secondaryBox24ia=" + secondaryBox24ia
				+ ", secondaryBox24ja=" + secondaryBox24ja + ", secondaryBox24jb=" + secondaryBox24jb
				+ ", secondaryIncludeBox24jbStatus=" + secondaryIncludeBox24jbStatus
				+ ", secondaryIncludePayerSalesOrderStatus=" + secondaryIncludePayerSalesOrderStatus
				+ ", secondaryWaitPreviousPayerBefrBillingStatus=" + secondaryWaitPreviousPayerBefrBillingStatus
				+ ", secondaryPayPercentageStatus=" + secondaryPayPercentageStatus + ", tertiaryInsurerId="
				+ tertiaryInsurerId + ", tertiaryInsurerName=" + tertiaryInsurerName + ", tertiaryInsuranceGroupId="
				+ tertiaryInsuranceGroupId + ", tertiaryInsuranceGroupName=" + tertiaryInsuranceGroupName
				+ ", tertiaryInsurancePlanId=" + tertiaryInsurancePlanId + ", tertiaryInsurancePlanType="
				+ tertiaryInsurancePlanType + ", tertiaryInsuranceStateId=" + tertiaryInsuranceStateId
				+ ", tertiaryInsuranceStateName=" + tertiaryInsuranceStateName + ", tertiaryInsurerPolicyno="
				+ tertiaryInsurerPolicyno + ", tertiaryInsurerPatientIdNumber=" + tertiaryInsurerPatientIdNumber
				+ ", tertiaryInsurerEffectiveDate=" + tertiaryInsurerEffectiveDate
				+ ", tertiaryInsurerVerificationStatus=" + tertiaryInsurerVerificationStatus
				+ ", tertiaryInsurerVerificationDate=" + tertiaryInsurerVerificationDate
				+ ", tertiaryInsurerPayPercentage=" + tertiaryInsurerPayPercentage + ", tertiaryBox10d="
				+ tertiaryBox10d + ", tertiaryBox19=" + tertiaryBox19 + ", tertiaryBox24ia=" + tertiaryBox24ia
				+ ", tertiaryBox24ja=" + tertiaryBox24ja + ", tertiaryBox24jb=" + tertiaryBox24jb
				+ ", tertiaryIncludeBox24jbStatus=" + tertiaryIncludeBox24jbStatus
				+ ", tertiaryIncludePayerInSalesOrderStatus=" + tertiaryIncludePayerInSalesOrderStatus
				+ ", tertiaryWaitPreviousPayerBeforeBillingStatus=" + tertiaryWaitPreviousPayerBeforeBillingStatus
				+ ", tertiaryPayPercentage0Status=" + tertiaryPayPercentage0Status + ", insuranceVerificationStatus="
				+ insuranceVerificationStatus + ", coverageVerificationStatus=" + coverageVerificationStatus
				+ ", excludeFromEligibilityCheckStatus=" + excludeFromEligibilityCheckStatus + ", patientPayPercentage="
				+ patientPayPercentage + ", patientIncludeThisPayorInSalesOrderStatus="
				+ patientIncludeThisPayorInSalesOrderStatus + ", patientWaitForPreviousPayerBeforeBillingStatus="
				+ patientWaitForPreviousPayerBeforeBillingStatus + ", workersCompDateOfOnset=" + workersCompDateOfOnset
				+ ", workersCompInjuryRelatedEmploymentStatus=" + workersCompInjuryRelatedEmploymentStatus
				+ ", workersCompInjuryRelatedAutoAccidentStatus=" + workersCompInjuryRelatedAutoAccidentStatus
				+ ", workersCompAutoAccidentStateId=" + workersCompAutoAccidentStateId
				+ ", workersCompInjuryRelatedToOtherAccidentStatus=" + workersCompInjuryRelatedToOtherAccidentStatus
				+ ", eclaimsAttachmentStatus=" + eclaimsAttachmentStatus + ", attachmentNumber=" + attachmentNumber
				+ ", typeCode=" + typeCode + ", transactionCode=" + transactionCode + ", claimsNoteType="
				+ claimsNoteType + ", claimsNote=" + claimsNote + ", salesOrderNo=" + salesOrderNo + ", status="
				+ status + ", createdById=" + createdById + ", createdByName=" + createdByName + ", createdDate="
				+ createdDate + ", updatedById=" + updatedById + ", updatedByName=" + updatedByName + ", updatedDate="
				+ updatedDate + ", salesOrderInsuranceDetailsUuid=" + salesOrderInsuranceDetailsUuid
				+ ", primaryInsurerPayerId=" + primaryInsurerPayerId + ", secondaryInsurerPayerId="
				+ secondaryInsurerPayerId + ", tertiaryInsurerPayerId=" + tertiaryInsurerPayerId + "]";
	}
