...
public class SalesOrderFinancialDetailsRowMapper implements BiFunction<Row, String, SalesOrderFinancialDetails> {
    ...
    public SalesOrderFinancialDetails apply(Row row, String prefix) {
        ...
        entity.setPrimaryInsurerCoveragePercentage(converter.fromRow(row, prefix + "_primary_insurer_coverage_percentage", Integer.class));
        ...
        entity.setSecondaryInsurerCoveragerPercentage(
            converter.fromRow(row, prefix + "_secondary_insurer_coverager_percentage", Integer.class)
        );
        ...
        entity.setTertiaryInsurerCoveragePercentage(
            converter.fromRow(row, prefix + "_tertiary_insurer_coverage_percentage", Integer.class)
        );
        ...
        entity.setPatientCoinsurancePercentage(converter.fromRow(row, prefix + "_patient_coinsurance_percentage", Integer.class));
        ...
        entity.setPrimaryInvoiceDate(converter.fromRow(row, prefix + "_primary_invoice_date", ZonedDateTime.class));
        entity.setSecondaryInvoiceDate(converter.fromRow(row, prefix + "_secondary_invoice_date", ZonedDateTime.class));
        entity.setTertiaryInvoiceDate(converter.fromRow(row, prefix + "_tertiary_invoice_date", ZonedDateTime.class));
