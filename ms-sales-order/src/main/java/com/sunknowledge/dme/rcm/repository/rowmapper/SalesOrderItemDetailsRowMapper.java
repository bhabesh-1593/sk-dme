...
//        entity.setId(converter.fromRow(row, prefix + "_id", Long.class));
        entity.setSalesOrderItemDetailsId(converter.fromRow(row, prefix + "_sales_order_item_details_id", Integer.class));
        entity.setSalesOrderId(converter.fromRow(row, prefix + "_sales_order_id", Integer.class));
        ...
        entity.setSalesOrderDetailItemId(converter.fromRow(row, prefix + "_sales_order_detail_item_id", Integer.class));
