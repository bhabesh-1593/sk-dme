...
//    private Long id;
	...
	public String toString() {
		return "SalesOrderClinicalDetails [salesOderClinicalDetailsId=" + salesOderClinicalDetailsId + ", salesOderId="
				+ salesOderId + ", patientId=" + patientId + ", patientWeightInKg=" + patientWeightInKg
				+ ", patientWeightInLbs=" + patientWeightInLbs + ", heightInInches=" + heightInInches + ", heightInCm="
				+ heightInCm + ", salesRepId=" + salesRepId + ", salesepName=" + salesepName + ", practitionerId="
				+ practitionerId + ", renderingProviderType=" + renderingProviderType + ", renderingProviderFacilityId="
				+ renderingProviderFacilityId + ", renderingProviderFacilityName=" + renderingProviderFacilityName
				+ ", renderingProviderId=" + renderingProviderId + ", renderingProviderFirstName="
				+ renderingProviderFirstName + ", renderingProviderMiddleName=" + renderingProviderMiddleName
				+ ", renderingProviderLastName=" + renderingProviderLastName + ", renderingProviderNpi="
				+ renderingProviderNpi + ", renderingProviderDea=" + renderingProviderDea
				+ ", renderingProviderAddressId=" + renderingProviderAddressId + ", renderingProviderAddressLine1="
				+ renderingProviderAddressLine1 + ", renderingProviderAddressLine2=" + renderingProviderAddressLine2
				+ ", renderingProviderCityName=" + renderingProviderCityName + ", renderingProviderStateName="
				+ renderingProviderStateName + ", renderingProviderZip=" + renderingProviderZip
				+ ", renderingProviderContactId=" + renderingProviderContactId + ", renderingProviderPhone1="
				+ renderingProviderPhone1 + ", renderingProviderPhone2=" + renderingProviderPhone2
				+ ", renderingProviderEmail=" + renderingProviderEmail + ", renderingProviderFax="
				+ renderingProviderFax + ", referringProviderType=" + referringProviderType
				+ ", referringProviderFacilityId=" + referringProviderFacilityId + ", referringProviderFacilityName="
				+ referringProviderFacilityName + ", referringProviderId=" + referringProviderId
				+ ", referringProviderFirstName=" + referringProviderFirstName + ", referringProviderMiddleName="
				+ referringProviderMiddleName + ", referringProviderLastName=" + referringProviderLastName
				+ ", referringProviderNpi=" + referringProviderNpi + ", referringProviderDea=" + referringProviderDea
				+ ", referringProviderAddressId=" + referringProviderAddressId + ", referringProviderAddressLine1="
				+ referringProviderAddressLine1 + ", referringProviderAddressLine2=" + referringProviderAddressLine2
				+ ", referringProviderCityName=" + referringProviderCityName + ", referringProviderStateName="
				+ referringProviderStateName + ", referringProviderZip=" + referringProviderZip
				+ ", referringProviderContactId=" + referringProviderContactId + ", referringProviderPhone1="
				+ referringProviderPhone1 + ", referringProviderPhone2=" + referringProviderPhone2
				+ ", referringProviderEmail=" + referringProviderEmail + ", referringProviderFax="
				+ referringProviderFax + ", orderingProviderType=" + orderingProviderType
				+ ", orderingProviderFacilityId=" + orderingProviderFacilityId + ", orderingProviderFacilityName="
				+ orderingProviderFacilityName + ", orderingProviderId=" + orderingProviderId
				+ ", orderingProviderFirstName=" + orderingProviderFirstName + ", orderingProviderMiddleName="
				+ orderingProviderMiddleName + ", orderingProviderLastName=" + orderingProviderLastName
				+ ", orderingProviderNpi=" + orderingProviderNpi + ", orderingProviderDea=" + orderingProviderDea
				+ ", orderingProviderAddressId=" + orderingProviderAddressId + ", orderingProviderAddressLine1="
				+ orderingProviderAddressLine1 + ", orderingProviderAddressLine2=" + orderingProviderAddressLine2
				+ ", orderingProviderCityName=" + orderingProviderCityName + ", orderingProviderStateName="
				+ orderingProviderStateName + ", orderingProviderZip=" + orderingProviderZip
				+ ", orderingProviderContactId=" + orderingProviderContactId + ", orderingProviderPhone1="
				+ orderingProviderPhone1 + ", orderingProviderPhone2=" + orderingProviderPhone2
				+ ", orderingProviderEmail=" + orderingProviderEmail + ", orderingProviderFax=" + orderingProviderFax
				+ ", marketingReferalTypeId=" + marketingReferalTypeId + ", marketingReferalTypeDescription="
				+ marketingReferalTypeDescription + ", marketingReferalId=" + marketingReferalId
				+ ", marketingReferalName=" + marketingReferalName + ", icd10DiagnosisCode1=" + icd10DiagnosisCode1
				+ ", icd10DiagnosisCode2=" + icd10DiagnosisCode2 + ", icd10DiagnosisCode3=" + icd10DiagnosisCode3
				+ ", icd10DiagnosisCode4=" + icd10DiagnosisCode4 + ", icd10DiagnosisCode5=" + icd10DiagnosisCode5
				+ ", icd10DiagnosisCode6=" + icd10DiagnosisCode6 + ", icd10DiagnosisCode7=" + icd10DiagnosisCode7
				+ ", icd10DiagnosisCode8=" + icd10DiagnosisCode8 + ", icd10DiagnosisCode9=" + icd10DiagnosisCode9
				+ ", icd10DiagnosisCode10=" + icd10DiagnosisCode10 + ", icd10DiagnosisCode11=" + icd10DiagnosisCode11
				+ ", icd10DiagnosisCode12=" + icd10DiagnosisCode12 + ", epsdtCertificationConditionIndicator="
				+ epsdtCertificationConditionIndicator + ", epsdtCertificationCode=" + epsdtCertificationCode
				...
				+ ", updatedDate=" + updatedDate + ", salesOrderClinicalDetailsUuid=" + salesOrderClinicalDetailsUuid
