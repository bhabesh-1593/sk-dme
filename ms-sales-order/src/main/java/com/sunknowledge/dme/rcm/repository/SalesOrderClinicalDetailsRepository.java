...
/**
 * Spring Data R2DBC repository for the SalesOrderClinicalDetails entity.
 */
...
public interface SalesOrderClinicalDetailsRepository
    ...
    @Query("SELECT * FROM t_sales_order_clinical_details entity WHERE entity.sales_order_master_sales_order_id = :id")
    Flux<SalesOrderClinicalDetails> findBySalesOrderMaster(Long id);

    @Query("SELECT * FROM t_sales_order_clinical_details entity WHERE entity.sales_order_master_sales_order_id IS NULL")
    Flux<SalesOrderClinicalDetails> findAllWhereSalesOrderMasterIsNull();
